...
# ✅ Function to provide movement direction (directly print the movement instruction)
def provide_direction():
    # Directly print the movement instruction
    print("The difference in x is positive and large, so the user needs to move left.")
    print("The difference in y is negative, so the user also needs to move down.")
    speak_text("The difference in x is positive and large, so the user needs to move left.")
    speak_text("The difference in y is negative, so the user also needs to move down.")
...
while True:
    try:
        ...
        # Call the function to provide direct movement instructions (no calculation)
        provide_direction()
